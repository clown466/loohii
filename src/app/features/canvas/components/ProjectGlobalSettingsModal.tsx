      ...
      <div className="flex max-h-[calc(100vh-2rem)] w-full max-w-[1080px] flex-col overflow-hidden rounded-lg border border-zinc-800 bg-[#111113] shadow-2xl">
        <div className="flex h-14 shrink-0 items-center justify-between border-b border-zinc-800 px-4">
          <div className="min-w-0">
            ...
            <div className="mt-0.5 truncate text-[13px] text-zinc-500">本项目后续资产、分镜、故事板和视频提示词推理都会读取这份设定</div>
          </div>
          ...
          <div className="grid gap-4 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
            <section className="space-y-4 rounded-lg border border-zinc-800 bg-[#141416] p-4">
              <div className="grid gap-3 sm:grid-cols-2">
                <div>
                  <label className="mb-1.5 block text-[14px] font-medium text-zinc-400">项目名称</label>
                  <input
                    className="h-9 w-full rounded-md border border-border bg-background px-3 text-[15px] text-zinc-100 outline-none focus:border-amber-500"
                    value={draft.title}
                    onChange={(event) => onChange({ title: event.target.value })}
                  />
                </div>
                <div>
                  <label className="mb-1.5 block text-[14px] font-medium text-zinc-400">默认比例</label>
                  <select
                    className="h-9 w-full rounded-md border border-border bg-background px-3 text-[15px] text-zinc-100 outline-none focus:border-amber-500"
                    value={draft.ratio}
              ...
              <div>
                <label className="mb-1.5 block text-[14px] font-medium text-zinc-400">项目描述</label>
                <PromptTextarea
                  className="h-20 w-full resize-none rounded-md border border-border bg-background px-3 py-2 text-[15px] leading-5 text-zinc-100 outline-none focus:border-amber-500"
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div>
                  <label className="mb-1.5 block text-[14px] font-medium text-zinc-400">风格</label>
                  <select
                    className="h-9 w-full rounded-md border border-border bg-background px-3 text-[15px] text-zinc-100 outline-none focus:border-amber-500"
                    value={draft.style}
                ...
                <div>
                  <label className="mb-1.5 block text-[14px] font-medium text-zinc-400">默认生成策略</label>
                  <select
                    className="h-9 w-full rounded-md border border-border bg-background px-3 text-[15px] text-zinc-100 outline-none focus:border-amber-500"
              ...
              {draft.style === '自定义' ? (
                <div>
                  <label className="mb-1.5 block text-[14px] font-medium text-zinc-400">自定义风格名称</label>
                  <input
                    className="h-9 w-full rounded-md border border-border bg-background px-3 text-[15px] text-zinc-100 outline-none focus:border-amber-500"
              ...
              <div>
                <label className="mb-1.5 block text-[14px] font-medium text-zinc-400">风格补充</label>
                <PromptTextarea
                  className="h-24 w-full resize-none rounded-md border border-border bg-background px-3 py-2 text-[15px] leading-5 text-zinc-100 outline-none focus:border-amber-500"
            ...
            <section className="space-y-4 rounded-lg border border-zinc-800 bg-[#141416] p-4">
              <div className="grid gap-3 md:grid-cols-2">
                <div>
                  <label className="mb-1.5 block text-[14px] font-medium text-zinc-400">项目调性</label>
                  <PromptTextarea
                    className="h-24 w-full resize-none rounded-md border border-border bg-background px-3 py-2 text-[15px] leading-5 text-zinc-100 outline-none focus:border-amber-500"
                ...
                <div>
                  <label className="mb-1.5 block text-[14px] font-medium text-zinc-400">导演人工指导</label>
                  <PromptTextarea
                    className="h-24 w-full resize-none rounded-md border border-border bg-background px-3 py-2 text-[15px] leading-5 text-zinc-100 outline-none focus:border-amber-500"
                ...
                <div>
                  <label className="mb-1.5 block text-[14px] font-medium text-zinc-400">角色身份约束</label>
                  <PromptTextarea
                    className="h-24 w-full resize-none rounded-md border border-border bg-background px-3 py-2 text-[15px] leading-5 text-zinc-100 outline-none focus:border-amber-500"
                ...
                <div>
                  <label className="mb-1.5 block text-[14px] font-medium text-zinc-400">负面约束</label>
                  <PromptTextarea
                    className="h-24 w-full resize-none rounded-md border border-border bg-background px-3 py-2 font-mono text-[14px] leading-5 text-zinc-100 outline-none focus:border-amber-500"
              ...
              <div>
                <label className="mb-1.5 block text-[14px] font-medium text-zinc-400">全局画面提示词</label>
                <PromptTextarea
                  className="h-28 w-full resize-y rounded-md border border-border bg-background px-3 py-2 font-mono text-[14px] leading-5 text-zinc-100 outline-none focus:border-amber-500"
              ...
              <div>
                <div className="mb-2 text-[14px] font-medium text-zinc-400">详细剧本规则</div>
                <div className="grid gap-3 md:grid-cols-2">
                  {PROJECT_SCRIPT_RULE_TEMPLATES.map((rule) => (
                    <div key={rule.id} className="rounded-md border border-zinc-800 bg-[#0d0d0f] p-3">
                      <div className="mb-1.5 text-[14px] font-medium text-zinc-200">{rule.title}</div>
                      <PromptTextarea
                        className="h-20 w-full resize-none rounded border border-zinc-800 bg-background px-2.5 py-2 text-[14px] leading-5 text-zinc-300 outline-none focus:border-amber-500"
        ...
        <div className="flex shrink-0 items-center justify-between gap-3 border-t border-zinc-800 px-4 py-3">
          <div className="min-w-0 text-[14px] text-red-300">{error}</div>
