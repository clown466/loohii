...
export const PromptOptimizerNode = ({ id, data, selected }: CanvasNodeProps) => {
  ...
  return (
    <>
      ...
      <div className={cn("scrollbar-none h-full w-full min-w-[460px] overflow-y-auto overflow-x-hidden rounded-[14px] border lh-node transition-colors hover:border-[#3A3A40]", selected && "lh-node-active")}>
