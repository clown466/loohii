  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-[22px] font-extrabold text-[#E8E8EC] sm:text-[24px]">个人信息</h1>
      </div>
        ...
        <div className="w-full max-w-md space-y-4">
          ...
          <div>
            ...
            <div className="flex flex-col items-start gap-2 sm:flex-row sm:items-center sm:gap-3">
              ...
              <span className="text-[#7ED887] text-[12px] whitespace-nowrap flex items-center gap-1"><Check className="h-3 w-3" />已验证</span>
            </div>
          </div>
        </div>
      ...
      <div className="lh-card relative mt-6 overflow-hidden rounded-xl border border-destructive/20 p-4 sm:mt-8 sm:p-6">
        ...
        <h3 className="text-[16px] font-medium text-destructive mb-2">危险操作</h3>
