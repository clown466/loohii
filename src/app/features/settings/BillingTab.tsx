  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-[24px] font-semibold text-foreground">账单充值</h1>
      ...
      <div className="grid gap-8">
        ...
        <div className="relative overflow-hidden rounded-xl border border-border bg-card p-4 sm:p-6">
          ...
          <div className="relative z-10 mb-8 flex flex-col items-start justify-between gap-4 sm:flex-row">
            ...
            <Badge className="bg-gradient-to-r from-primary to-primary/80 text-white border-0 py-1">Pro 套餐</Badge>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            {[
              ...
              <div
                key={i}
                className={cn(
                  "relative rounded-xl border p-5 cursor-pointer transition-all flex flex-col items-center justify-center bg-card",
                  pack.popular
                    ? "border-transparent h-[120px] bg-gradient-to-b from-[#18181b] to-[#18181b] before:absolute before:inset-0 before:-z-10 before:p-[2px] before:rounded-xl before:bg-gradient-to-br before:from-primary before:to-primary/80 shadow-[0_4px_24px_-8px_rgba(245,166,35,0.5)] z-10"
                    : "border-border h-[112px] hover:border-primary/50 mt-1"
                )}
              >
                {pack.popular && (
                  <div className="absolute -top-3 bg-gradient-to-r from-primary to-primary/80 text-white text-[11px] font-medium px-2.5 py-0.5 rounded-md flex items-center gap-1 shadow-sm">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              { name: '微信支付', color: "text-[#09b83e]", border: "border-border", bg: "bg-card" },
              { name: '银联', color: "text-[#ef4444]", border: "border-border", bg: "bg-card" }
            ].map((method, i) => (
              <button
                key={i}
                className={cn(
        ...
        <div className="pt-2">
          ...
          <div className="overflow-x-auto rounded-xl border border-border bg-card">
            <table className="w-full min-w-[520px] text-left text-[13px]">
              <thead className="bg-layer-4 text-[#71717a] border-b border-border">
                <tr>
              ...
              <tbody className="divide-y divide-[#1f1f23]">
                {[
                  ...
                  <tr key={i} className="hover:bg-layer-4/50 transition-colors">
                    ...
                    <td className={`px-5 py-3 font-medium ${row.isAdd ? 'text-[#22c55e]' : 'text-foreground'}`}>
                      {row.amount}
                    </td>
