...
export function SettingsPage() {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden bg-background text-[16px] md:flex-row">
      {/* Settings Sidebar */}
      <div className="flex w-full shrink-0 flex-col border-b border-[#222226] bg-[#141417] p-3 md:w-64 md:border-b-0 md:border-r md:p-4">
        <h2 className="mb-3 px-1 text-[20px] font-extrabold text-[#E8E8EC] md:mb-6 md:px-2">设置</h2>
          ...
          {menuItems.map((item) => {
            ...
            return (
              <Link
                ...
                to={item.path}
                className={cn(
                  "relative flex h-10 shrink-0 items-center gap-3 rounded-md px-3 py-2 text-[16px] font-medium transition-colors group",
                  isActive
